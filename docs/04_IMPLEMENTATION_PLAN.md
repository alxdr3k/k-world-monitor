...
| `P0-M2` | Source Registry & Collection Queue — Tier A seed (size cap 없음, v0 entry 72 source proposed) + collectability_score + source policy gate + discovery → 큐 → fingerprint snapshot → chunk 1건 end-to-end | TBD | planned | AC-001, AC-009, AC-020, AC-022, AC-024 | TBD | M1 의존 |
...
| `INFRA-1A.4` | P0-M1 | INFRA | INFRA-1A | Neo4j edge UNIQUE constraint (5 relation type) + frontmatter 관계 배열 lint (배열 발견 시 CI fail) | INFRA-1A.2 | AC-008 | defined | in_progress | tests/lint/no_frontmatter_relation_array_test.ts (9 tests); Neo4j edge UNIQUE constraints landed in INFRA-1A.2 | INFRA-1A.5 |
| `INFRA-1A.5` | P0-M1 | INFRA | INFRA-1A | text normalization util + sha256 helper + quote_reason enum / storage_level enum migration | INFRA-1A.2 | AC-007 | defined | ready | TBD | INFRA-1A.6 |
...
| `INFRA-1A.7` | P0-M1 | INFRA | INFRA-1A | Scenario / Thesis / Source schema에 v0 즉시 bidirectional 필드 추가 (impact_targets, impact_direction_by_target, transmission_channels, stance, market_stance optional, source_perspective) | INFRA-1A.2 | AC-026, AC-027 | defined | ready | TBD | INFRA-1A.8 |
