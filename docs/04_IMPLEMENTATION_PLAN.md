...
| `INFRA-1A.7` | P0-M1 | INFRA | INFRA-1A | Scenario / Thesis / Source schema에 v0 즉시 bidirectional 필드 추가 (impact_targets, impact_direction_by_target, transmission_channels, stance, market_stance optional, source_perspective) | INFRA-1A.2 | AC-026, AC-027 | defined | in_progress | migrations/neo4j/v1_schema.cypher (Scenario property schema + indexes); src/utils/enums.ts (THESIS_STANCE/THESIS_MARKET_STANCE/SOURCE_PERSPECTIVE); src/domain/nodes.ts; tests/unit/bidirectional_schema_test.ts (27 tests) | INFRA-1A.8 |
