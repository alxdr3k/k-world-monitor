...
| `P0-M2` | Source Registry & Collection Queue — Tier A 30~50 seed + collectability_score + source policy gate + discovery → 큐 → fingerprint snapshot → chunk 1건 end-to-end | TBD | planned | AC-001, AC-009, AC-020, AC-022, AC-024 | TBD | M1 의존 |
...
| `P0-M6` | Thesis & Content & Cite Check — Thesis(stance + market_stance) → ContentDraft 4-format → Publication 1건 + cite check 5+1 + cascade + EvidencePack v0 4-section | TBD | planned | AC-013, AC-016, AC-018, AC-026, AC-028 | TBD | M5 의존 — MVP hands-on gate |
...
| `PUB` | content_draft 4-format / cite_check 5+1 / publication / cascade / vault sync | `PUB-1A` | planned | M6 owner |
...
| `INFRA-1A.6` | P0-M1 | INFRA | INFRA-1A | Source registry seed Q21 — Tier A 30~50개 + source_perspective 분포 균형 + collectability_score 초기치 | INFRA-1A.2, Q-021 resolution | AC-022, AC-027 | defined | planned | TBD | INFRA-1A.7 |
...
| `PUB-1A.1` | P0-M6 | PUB | PUB-1A | ContentDraft composer (4-format: blog_long / youtube_long / shorts / newsletter) + 인용 ledger + Thesis 재사용 | AGG-1A.4 | AC-018 | defined | planned | TBD | PUB-1A.2 |
| `PUB-1A.2` | P0-M6 | PUB | PUB-1A | Cite Check 5+1 (stale / retracted / horizon / unit / overclaim + unresolved HIGH/CRITICAL access_intervention + v1+ one-sided thesis warning) + EvidencePack v0 4-section | PUB-1A.1, OPS-1B.1, INFRA-1B.5 | AC-013, AC-028 | defined | planned | TBD | PUB-1A.3 |
| `PUB-1A.3` | P0-M6 | PUB | PUB-1A | Publication ledger + cascade alert (Q-003 결정 반영) + vault sync trigger (Q-026) | PUB-1A.2, Q-003 resolution, Q-026 resolution | AC-013 | defined | planned | TBD | MVP gate |
...
- Q-021: Tier A source seed 30~50개 + source_perspective 분포 균형 — INFRA-1A.6
  진입 전 lock
- Q-022: v0 카테고리 8개 finalize + tag 5개 + axis transmission_channel —
  INFRA-1A.6 진입 전 lock
- Q-024: Neo4j-specific 기능 활용 boundary — INFRA-1A.2 commit 전 lock 권고
- Q-025: 외부 repo 부트스트랩 cadence — INFRA-1A.1 완료 후 재평가
- Q-026: Vault sync trigger — PUB-1A.3 진입 전 lock
- Q-027: 백업 schedule + R2 lifecycle — INFRA-1A.8 진입 전 lock
- Q-028: LLM API cost 통제 정책 — EXTR-1A.2 진입 전 lock
