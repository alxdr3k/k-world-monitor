...
| `P0-M3` | Extraction & Review — Haiku 1차 + Sonnet escalate + auto-confirm + reviewer queue + manual feedback CLI + access_intervention batch report | TBD | partially_landed (cross-milestone early) | AC-007, AC-010, AC-015, AC-019, AC-024, AC-025, SPIKE-002 | **M3 own slices** (early-landed during M2 phase): INFRA-1B.6 (manual feedback CLI, PR #22 7f4e980, 2026-05-12) + OPS-1A.1 (run ledger, PR #23 23de14c, 2026-05-12 — 본 slice 의 **migrations/sqlite/v4_run_ledger_completed_at_idx.sql** 도 M3 own evidence). 나머지 M3 slices (EXTR-1A.0 ~ 1A.6, OPS-1A.2 ~ 1A.4) 는 planned. AC-007/010/015/019 evidence 는 EXTR-1A.* 진입 시 추가 | M2 의존. INFRA-1B.6 + OPS-1A.1 early-landed (M2 작업 안에서 leaf slice 로 흡수); 나머지 M3 slice 는 P0-M2 gate accept 후 진입 |
