...
| `OPS-1A.1` | P0-M3 | OPS | OPS-1A | Run ledger 테이블 + cost 집계 | INFRA-1A.2 | AC-019 | defined | in_progress | src/ops/run-ledger.ts (startRun/completeRun/failRun/getDailyCostUsd/getDailyCostBreakdown); tests/unit/run_ledger_test.ts (13 tests); PR #23 open | OPS-1A.2 |
