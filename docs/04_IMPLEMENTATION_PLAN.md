...
| `INFRA-1A.5` | P0-M1 | INFRA | INFRA-1A | text normalization util + sha256 helper + quote_reason enum / storage_level enum migration | INFRA-1A.2 | AC-007 | defined | in_progress | src/utils/text.ts + hash.ts + enums.ts; migrations/sqlite/v2_enum_constraints.sql (enum triggers); tests/unit/text_hash_test.ts (49 tests) | INFRA-1A.6 |
