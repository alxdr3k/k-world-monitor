...
| `INFRA-1A.2` | P0-M1 | INFRA | INFRA-1A | Neo4j Cypher schema v1 + SQLite relational schema v1 + 마이그레이션 commit (Source/Document/Snapshot/Claim/Edge/Run/AccessIntervention/ManualClaimEntry/Thesis 노드 + source_policy/policy_decisions/dataset_vintage/metrics_*/evaluation_*/policy_learning_*/research_session/raw_cache_items 테이블) | INFRA-1A.1, SPIKE-001 | AC-002, AC-005 | defined | in_progress | migrations/neo4j/v1_schema.cypher + migrations/sqlite/v1_schema.sql + src/storage/ + scripts/migrate.ts + src/domain/ids.ts + tests/lint/id_prefix_test.ts; Q-004/Q-020/Q-024 resolved | INFRA-1A.3 |
