...
| Build gate | Astro Content Collection + Zod schema (status / cite_refs[] / correction_ledger[] / format) — dead-link cite_refs 또는 invalid status 는 **build fail** (ADR-0022 INV-0022-3, AC-034) |
