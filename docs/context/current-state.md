...
- active phase: `EXTR-1A` (Cycle 38 — operator "extra 진입" 2026-05-19, EXTR-1A.0 landed via 본 PR, EXTR-1A.1 router 개시 가능 상태); `INFRA-1B` (게이트 검증 단계); `OPS-1A` (게이트 검증 단계)
- active slice: **EXTR-1A.0-prompt-injection-defense** (Cycle 38 본 PR — ADR-0029 INV-0029-1/3/4/5 enforcement; 3 modules in `src/extraction/sanitize|prompt|policy/`; PRE-0029-2 충족 → EXTR-1A.1 extractor router 개시 unblock). **Prior landed slices**: M2 own slices INFRA-1B.1 ~ INFRA-1B.5 (P0-M2 gate accept evidence 대상) + cross-milestone early landed P0-M3 slices INFRA-1B.6 (feedback CLI, PR #22 7f4e980) + OPS-1A.1 (run ledger, PR #23 23de14c). P0-M2 게이트 검증 미실시 evidence: SPIKE-001 (NFR-001 1만 graph object < 1s p95), AC-022/023/024 evidence 확정. 2026-05-13 comprehensive review 가 식별한 doc-code drift 일괄 backfill 됨. **P0-M2-hardening engineering sequence + INFRA-1A.9 follow-up (Cycle 14-37) 모두 landed** (operator D1-D6 sequence 완료, D7 phase 진입 시작). Landed M2 own PR 목록: #15 (INFRA-1B.1 source registry seed + 1B.1.x hotfix, c51b2ce), #16 (INFRA-1B.2a safe-fetch, ed09aa5), #17 (INFRA-1B.2b scheduler, 0eec962), #18 (INFRA-1B.2 discovery worker, 896ddf2), #19 (INFRA-1B.3 snapshot fingerprint, 4dfa94f), #20 (INFRA-1B.4 chunker, 06c49d7), #21 (INFRA-1B.5 access-intervention, c3b19c4), #22 / #23 (early-land P0-M3 slices).
