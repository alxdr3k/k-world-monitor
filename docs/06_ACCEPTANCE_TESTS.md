...
| TEST-023 | policy gate mode-aware + 8 위험 행동 — ADR-0017 INV-0017-3 stage-default mode + INV-0017-4 mode-invariant inline_block + INV-0017-5 policy_decisions ledger persistence | `tests/policy/gate_test.ts` ✓ 56 tests pass (INFRA-1B.5.h2, 본 PR landed): 6 stageDefaultMode + 27 detectRisks (8 trigger × fire/not-fire/mode-invariance + Codex PR #68 P1 fix: bare AP word-boundary + AFP/TASS word-boundary + 5 false-positive defense) + 8 evaluatePolicyGate + 6 recordPolicyGateDecision (intended_action=NULL namespace + writer-boundary guard) + 9 TEST-023 E2E (8 trigger × ledger record × INV-0017-4 mode-invariance verified across 5 stages) | AC-023 |
