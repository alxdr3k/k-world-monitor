...
| TRACE-040 | Q-044 → DEC-020 | ADR-0012 + ADR-0017 + DEC-020 | NFR-008 | AC-032 / TEST-032 | P0-M2 (hardening) | INFRA | INFRA-1B | INFRA-1B.3.x-audit (신규) | NFR-008 audit log 코드 enforcement — `src/storage/audit/policy-decisions.ts` 신규 + IntendedAction enum + caller hookup. snapshot-fingerprint r2Put 전후 명시적 INSERT |
